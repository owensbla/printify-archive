        ...
        Plugin.prototype = {
            init: function () {
                ...
                this.$label.css({
                    ...
                    'left'                          : '10px', //thisElement.css('padding-left'),
                    'display'                       : 'none',
                    '-moz-opacity'                  : '0',
                    '-khtml-opacity'                : '0',
                    '-webkit-opacity'               : '0',
                ...
                thisElement.on('blur', function() { thisElement.prev('label').removeClass('is-active'); });
                thisElement.on('focus', function() { thisElement.prev('label').addClass('is-active'); });
