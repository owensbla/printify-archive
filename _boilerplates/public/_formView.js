...
var BoilerplateView = Backbone.FormView.extend({
  
  // template: App.Templates['layouts/pages/home'],

  // fields: {
  //   'number': {
  //     validators: ['requiredValidator', 'stripeCardValidator']
  //   },
  //   'name': {
  //     validators: ['requiredValidator']
  //   },
  //   'expiry': {
  //     validators: ['requiredValidator', 'stripeExpiryValidator']
  //   },
  //   'cvc': {
  //     validators: ['requiredValidator', 'stripeCVCValidator']
  //   }
  // },

  // saveSelector: '.js-complete',
  // successMessage: '',
...
module.exports = BoilerplateView;